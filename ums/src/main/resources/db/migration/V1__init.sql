...
(X'F2A8C5E58E1A4C8B9D1234A6B7C8D9E0', 'Admin', 'admin@admin.ru', 'admin', HEX(RANDOM_BYTES(32)), '1700000000', NULL);
...
(X'F2A8C5E58E1A4C8B9D1234A6B7C8D9E0', X'43DCF1D63AC0429099FD44F9B9F9BECF');
